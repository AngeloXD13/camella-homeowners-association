...
<body id="page-top">
    ...
    <section class="page-section bg-light" id="announcement">
        <div class="container">
            ...
            <div class="row">
                ...
                @if (count($public_announcements) > 0)
                    @foreach ($public_announcements as $announcement)
                        <div class="col-lg-4 col-sm-6 mb-4">
                            <!-- Announcement item 1-->

                            @foreach ($announcements_files as $files => $val)
                                @if ($val['announcement_id'] === $announcement->id)
                                    <?php $announcement_thumbnail = asset('storage/images/announcement/') . '/' . $announcements_files[$files]['filename']; ?>
                                @endif
                            @endforeach
                            ...
                            <div class="announcement-item">
                                <a class="announcement-link" data-bs-toggle="modal" href="#announcementModal1">
                                    ...
                                    @if (isset($announcement_thumbnail))
                                        <img class="img-fluid thumbnail-announcement"
                                            src="{{ $announcement_thumbnail }}" alt="..." />
                                    @endif

                                </a>
                                <div class="announcement-caption">
                                    <div class="announcement-caption-heading">{{ $announcement->subject }}</div>
                                    <div class="announcement-caption-subheading text-muted"
                                        id="announcement-item-description-{{ $announcement->id }}"></div>
                                    {{-- <div class="text-muted"
                                        id="announcement-item-dateposted-{{ $announcement->id }}"></div> --}}
                                </div>
                                <script>
                                    document.getElementById("announcement-item-description-{{ $announcement->id }}").innerHTML =
                                        "{{ $announcement->description }}";
                                    // document.getElementById("announcement-item-dateposted-{{ $announcement->id }}").innerHTML = "{{ 'Posted in ' . $announcement->updated_at }}";
                                </script>
                            </div>
                        </div>
                    @endforeach
                @else
                    <div class="text-center">
                        <h3 class=" section-subheading text-muted">No Announcements</h3>
                    </div>
                @endif
            </div>
        </div>
    ...
    <div class="announcement-modal modal fade" id="announcementModal1" tabindex="-1" role="dialog"
        aria-hidden="true">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                ...
                                <img class="img-fluid d-block mx-auto" src="assets/img/announcement/1.jpg"
                                    alt="..." />
    ...
    <div class="announcement-modal modal fade" id="announcementModal2" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-bs-dismiss="modal"><img src="assets/img/close-icon.svg"
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                ...
                                <h2 class="text-uppercase">Project Name</h2>
                                <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                <img class="img-fluid d-block mx-auto" src="assets/img/announcement/2.jpg"
                                    alt="..." />
                                <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt
                                    repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae,
    ...
    <div class="announcement-modal modal fade" id="announcementModal3" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-bs-dismiss="modal"><img src="assets/img/close-icon.svg"
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                ...
                                <h2 class="text-uppercase">Project Name</h2>
                                <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                <img class="img-fluid d-block mx-auto" src="assets/img/announcement/3.jpg"
                                    alt="..." />
                                <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt
                                    repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae,
    ...
    <div class="announcement-modal modal fade" id="announcementModal4" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-bs-dismiss="modal"><img src="assets/img/close-icon.svg"
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                ...
                                <h2 class="text-uppercase">Project Name</h2>
                                <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                <img class="img-fluid d-block mx-auto" src="assets/img/announcement/4.jpg"
                                    alt="..." />
                                <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt
                                    repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae,
    ...
    <div class="announcement-modal modal fade" id="announcementModal5" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-bs-dismiss="modal"><img src="assets/img/close-icon.svg"
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                ...
                                <h2 class="text-uppercase">Project Name</h2>
                                <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                <img class="img-fluid d-block mx-auto" src="assets/img/announcement/5.jpg"
                                    alt="..." />
                                <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt
                                    repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae,
    ...
    <div class="announcement-modal modal fade" id="announcementModal6" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-bs-dismiss="modal"><img src="assets/img/close-icon.svg"
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                ...
                                <h2 class="text-uppercase">Project Name</h2>
                                <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                <img class="img-fluid d-block mx-auto" src="assets/img/announcement/6.jpg"
                                    alt="..." />
                                <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt
                                    repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae,
