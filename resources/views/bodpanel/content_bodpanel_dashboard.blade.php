...
{{-- @extends('bodpanel/layout_topbar') --}}
...
@section('bodpanel_content')
    ...
    {{-- <h1>Board of Director Dashboard</h1> --}}
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Board of Directors/Management Dashboard</h1>
                <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                        class="fas fa-download fa-sm text-white-50"></i> Generate Report (Soon)</a>
            </div>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                        Total Website Users(Monthly)</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">1293</div>
                                </div>
                                <div class="col-auto">
                    ...
                    <div class="card border-left-warning shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                        Pending Homeowner/User Registration Requests</div>
    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-center my-auto">
                <span>Copyright © Camella Solamente Home Owner Association 2022 - All Rights Reserved.</span>
            </div>
        </div>
    </footer>
    <!-- End of Footer -->
